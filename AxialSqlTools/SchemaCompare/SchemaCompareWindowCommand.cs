...
namespace AxialSqlTools
{
    ...
    internal sealed class SchemaCompareWindowCommand
    {
        ...
        /// Command ID.
        /// </summary>
        public const int CommandId = 4149;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SchemaCompareWindowCommand"/> class.
        ...
        {
            // Switch to the main thread - the call to AddCommand in SchemaCompareWindowCommand's constructor requires
            // the UI thread.
