...
namespace AxialSqlTools
{
    ...
    internal sealed class QuickSearchWindowCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QuickSearchWindowCommand"/> class.
        ...
        /// </summary>
        public static QuickSearchWindowCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in QuickSearchWindowCommand's constructor requires
            // the UI thread.
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            {
                ToolWindowPane window = await this.package.FindToolWindowAsync(typeof(QuickSearchWindow), 0, true, this.package.DisposalToken);
                await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);
