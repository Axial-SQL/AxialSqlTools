...
6. Cancel during a large capture and during aggregation; close a busy pivot tab. SSMS should remain usable. Verify light/dark themes, horizontal scrolling, and Ctrl+C from the output.
