...
namespace AxialSqlTools
{
    ...
    internal sealed class DataImportWindowCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DataImportWindowCommand"/> class.
        ...
        /// </summary>
        public static DataImportWindowCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in DataImportWindowCommand's constructor requires
            // the UI thread.
